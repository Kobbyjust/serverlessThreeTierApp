...
class StaticSite(Construct):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Internal variables
        self._site_domain_name = "myfrontend123"
    ...
    #   Creating S# Bucket and Cloudfront Distribution
...
class StaticSitePublicS3(StaticSite):
    ...
    def __get_referer_header(self, parameter_name):
        return ssm.StringParameter.from_string_parameter_attributes(
            self, "origin_custom_header_parameter_name" , parameter_name="origin_custom_header_parameter_name"
        ).string_value
